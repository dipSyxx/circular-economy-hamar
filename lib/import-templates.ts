...
eksempel-aktor,Eksempel Aktor,brukt,Kort beskrivelse,Lang beskrivelse,Gate 1 0001 Oslo,0001,Oslo,oslo,Oslo,oslo,Oslo,,59.9139,10.7522,+4712345678,post@example.no,https://example.no,,Man-fre 10:00-18:00|Lor 11:00-16:00,Mo-Fr 10:00-18:00; Sa 11:00-16:00,second hand|lokal,Reduserer avfall|gir nytt liv,Lever inn varer|Besok butikken,,false,akershus,baerum`,
  actor_sources: `actor_slug,type,title,url,captured_at,note
eksempel-aktor,website,Offisiell nettside,https://example.no,2026-03-29,Primarkilde for aapningstider og kontaktinfo`,
