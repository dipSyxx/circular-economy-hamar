...
export const decideCopy = {
  ...
  ai: {
    ...
    loadingLabel: "Analyserer problemet...",
    resetLabel: "Nytt AI-søk",
    errorLabel: "Kunne ikke hente AI-vurdering akkurat nå.",
    adviceTitle: "AI-råd",
    adviceDescription: "Kort oppsummering før vi viser anbefalingen og aktuelle steder.",
    warningTitle: "Vær oppmerksom på",
    interpretationTitle: "Slik tolket vi beskrivelsen",
    interpretationDescription: "AI-modusen oversetter friteksten din til støttede kategorier i beslutningsmotoren.",
    assumptionsTitle: "Antakelser",
    balancedFallbackLabel: "Balansert",
    examples: [
      "Bordbenet er løst og bordet vingler.",
      "Sålen på joggeskoene løsner.",
      "Jakken har ødelagt glidelås.",
      "Telefonskjermen virker ikke.",
    ],
  },
